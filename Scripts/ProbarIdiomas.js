...
assert.equal(normalizarIdioma(['sv']), 'sv-SE')
assert.equal(normalizarIdioma(['sv-SE']), 'sv-SE')
assert.equal(normalizarIdioma(['nb']), 'nb-NO')
assert.equal(normalizarIdioma(['nb-NO']), 'nb-NO')
assert.equal(normalizarIdioma(['no']), 'nb-NO')
assert.equal(normalizarIdioma(['no-NO']), 'nb-NO')
assert.equal(normalizarIdioma(['nn-NO']), IDIOMA_PREDETERMINADO)
